...
; Characteristics of each move.
	...
	move FIRE_PUNCH,   RECOIL_EFFECT,              120, FIRE,         100, 15
	move ICE_PUNCH,    RECOIL_EFFECT,              120, ICE,          100, 15
	move THUNDERPUNCH, RECOIL_EFFECT,              120, ELECTRIC,     100, 15
	move SCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        55, BUG,          100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   NO_ADDITIONAL_EFFECT,        45, FLYING,       100, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        50, NORMAL,        95, 30
	move GUST,         NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,        80, FLYING,       100, 35
	move WHIRLWIND,    NO_ADDITIONAL_EFFECT,       110, FLYING,        85,  5
	move FLY,          FLY_EFFECT,                  70, FLYING,        95, 15
	move BIND,         TRAPPING_EFFECT,             35, BUG,           85,  5
	...
	move JUMP_KICK,    JUMP_KICK_EFFECT,            90, FIGHTING,      95, 10
	...
	move WRAP,         TRAPPING_EFFECT,             35, NORMAL,        85,  5
	...
	move POISON_STING, POISON_SIDE_EFFECT1,         95, POISON,       100, 35
	...
	move ACID,         DEFENSE_DOWN1_EFFECT,        70, POISON,       100, 30
	move EMBER,        BURN_SIDE_EFFECT3,           40, FIRE,         100, 25
	...
	move SUBMISSION,   RECOIL_EFFECT,              100, FIGHTING,     100, 20
	...
	move FIRE_SPIN,    TRAPPING_EFFECT,             35, FIRE,          85,  5
	move THUNDERSHOCK, PARALYZE_SIDE_EFFECT1,       55, ELECTRIC,     100, 30
	...
	move SPLASH,       PARALYZE_SIDE_EFFECT2,       60, FLYING,       100, 40
	...
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        85, ROCK,         100, 10
	move HYPER_FANG,   SPECIAL_SELFDOWN2,          150, DRAGON,        90, 15
	move SHARPEN,      ATTACK_SPECIAL_UP1_EFFECT,    0, NORMAL,       100, 30
	move CONVERSION,   CONVERSION_EFFECT,            0, NORMAL,       100, 30
	move TRI_ATTACK,   NO_ADDITIONAL_EFFECT,        80, GHOST,        100, 10
